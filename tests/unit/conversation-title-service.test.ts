...
import { generateConversationTitleFromPrompt, mapConversationTitleErrorToHttp } from "../../src/server/services/conversationTitleService";
beforeEach(() => {
...
describe("conversation title service", () => {
    it("returns sanitized LLM title for valid input", async () => {
        ...
        expect(generateResponseMock).toHaveBeenCalledWith(expect.objectContaining({
